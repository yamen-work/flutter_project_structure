...
final Map<String, Map<ErrorCode, String>> errorMessages = {
  'en': {
    ...
    ErrorCode.WRONG_PASSWORD: 'The password is incorrect.',
    ErrorCode.EMAIL_ALREADY_IN_USE:'An account already exists with this email address.',
    ErrorCode.WEAK_PASSWORD: 'The password is too weak.',
  },
  ...
  'ar': {
    ...
    // Firebase Authentication
    ErrorCode.INVALID_EMAIL:'يرجى إدخال بريد إلكتروني صالح.',
    ErrorCode.WRONG_PASSWORD:'كلمة المرور غير صحيحة.',
    ErrorCode.EMAIL_ALREADY_IN_USE:'يوجد حساب مرتبط بهذا البريد الإلكتروني مسبقًا.',
    ErrorCode.WEAK_PASSWORD:'كلمة المرور ضعيفة جدًا.',
  },
};